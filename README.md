...
- [x] **Smart Resume**: specific implementation to save the current word index in `config.json` and resume reading from that exact spot.
- [x] **History and TextSaving**: Implementation of Past Texts Read and history usage. 
